...
image_directory='./images/jupiter.png'
models_directory = './models/*.h5'

image = Read_Preprocess_Image(image_directory,NORMALIZE=1, CONV_GS=1, INVERSE=1,EQUALIZE=0, CLAHE=1,                              RESIZE=1)

Objects_Master_list = model_inference(image,models_directory,which_models='all')


# In[3]:


objects_unique = get_unique_iou(Objects_Master_list,iou_thres=0.5,detection_thres=0.9)
